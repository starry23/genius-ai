...
public class GenerateCode {
    ...
    public static void main(String[] args) {
        ...
        String baseUrl = System.getProperty("user.dir") + "/ai-server";
        //1、配置数据源
        FastAutoGenerator.create(
                        "jdbc:mysql://127.0.0.1:3306/genius_ai?socketTimeout=4000&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=Asia/Shanghai",
                        "root", "root")
                .globalConfig(builder -> {
                    builder.author("apeto") // 设置作者名
                            .outputDir(baseUrl + "/src/main/java")   //设置输出路径
                            .commentDate("yyyy-MM-dd hh:mm:ss")   //注释日期
                            .dateType(DateType.ONLY_DATE)   //定义生成的实体类中日期的类型 TIME_PACK=LocalDateTime;ONLY_DATE=Date;
//              .enableSwagger()   //开启 swagger 模式
                            .disableOpenDir();   //禁止打开输出目录，默认打开
                }).packageConfig(builder -> builder.parent("cn.apeto.geniusai.server") // 设置父包名
                        ...
                        .pathInfo(Collections.singletonMap(OutputFile.xml, baseUrl + "/src/main/resources/mapper")))
                .strategyConfig(builder ->
                        builder
                                .addInclude(getTables("bot_chat_session_record,bot_chat_log")) // 设置需要生成的表名 可边长参数“user”, “user1”
