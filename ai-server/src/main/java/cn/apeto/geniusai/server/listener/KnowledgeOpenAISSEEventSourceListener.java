 ...
 */
@Slf4j
public class KnowledgeOpenAISSEEventSourceListener extends BaseEventSourceListener {


    public KnowledgeOpenAISSEEventSourceListener(SseEmitter sseEmitter) {
        super(sseEmitter);
    }
